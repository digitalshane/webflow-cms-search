...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:5c37cef2\\-80ae\\-45c4\\-91ea\\-13d0fd37dd74\\.wf\\-app\\-prod\\.cosmic\\.webflow\\.services)$)$", port: "", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }];
